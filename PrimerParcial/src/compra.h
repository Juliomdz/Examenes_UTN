...
int com_getIdClienteByCompra(Compra* arrayCompras,int limite, int*idClienteObtenido,
                             int* indiceCompraObtenido);
...
int com_imprimirClientesConContrataciones(Cliente* arrayClientes,int limiteClientes,
...
int com_altaForzada(Compra* arrayCompra,int indice,int limite,float importe,
                    char* color, char* direccion, int cantidadBarbijos,
                    int idCliente, int status,int* id);
int com_imprimirClientesPorId(Cliente* arrayClientes,int limite,
